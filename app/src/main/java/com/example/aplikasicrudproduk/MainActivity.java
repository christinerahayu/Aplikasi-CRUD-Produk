...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    View dialogView;
    TextView kodeProduk, namaProduk, jP, harga, jumlah, tanggalMasuk;
    ...
    public void onItemClick(AdapterView<?> parent, View view, int i, long x) {
        TextView getId = (TextView)view.findViewById(R.id.listIDproduk);
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which){
                    case 0:
                        ...
                        kodeProduk = (TextView)dialogView.findViewById(R.id.KodeProduk);
                        namaProduk = (TextView)dialogView.findViewById(R.id.NamaProduk);
                        jP = (TextView)dialogView.findViewById(R.id.JP);
                        harga = (TextView)dialogView.findViewById(R.id.Harga);
                        jumlah = (TextView)dialogView.findViewById(R.id.Jumlah);
                        tanggalMasuk = (TextView)dialogView.findViewById(R.id.TanggalMasuk);

                        kodeProduk.setText("Kode Produk: " + cur.getString(cur.getColumnIndex(DBHelper.row_kodeProduk)));
                        namaProduk.setText("Nama Produk: " + cur.getString(cur.getColumnIndex(DBHelper.row_namaProduk)));
                        jP.setText("Jenis Produk: " + cur.getString(cur.getColumnIndex(DBHelper.row_jp)));
                        ...
                        tanggalMasuk.setText("Tanggal Masuk: " + cur.getString(cur.getColumnIndex(DBHelper.row_tanggalMasuk)));
